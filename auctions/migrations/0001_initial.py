    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, help_text='Enter a valid phone number.', max_length=15, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('videos', models.FileField(blank=True, null=True, upload_to='vehicle_videos/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            model_name='auction',
            name='vehicle',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='auctions.vehicle'),
        ),
        migrations.CreateModel(
